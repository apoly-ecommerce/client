...
export default {
  ...
  methods: {
    ...
    async list() {
      await this.fetchListUserByPaginate(this.listQuery);
      this.isTabTrashed = false;
    },
    async trashed() {
      await this.fetchListUserTrashedByPaginate(this.listQuery);
