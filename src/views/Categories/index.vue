...
export default {
  ...
  methods: {
    ...mapActions({
        ...
        'emptyTrashCategory': 'category/emptyTrashCategory'
    }),
    formatTime(time) {
    ...
    async list() {
      await this.fetchCategoryByPaginate(this.listQuery);
      this.isTabTrashed = false;
    },
    async trashed() {
      await this.fetchListCategoryTrashedByPaginate(this.listQuery);
