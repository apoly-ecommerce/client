...
export default {
  ...
  computed: {
    ...mapGetters({
      'tableData': 'inventory/getInventories',
  ...
  methods: {
    ...
    async list() {
      await this.fetchListInventoryByPaginate(this.listQuery);
      this.isTabTrashed = false;
    },
    async trashed() {
      await this.fetchListInventoryTrashedByPaginate(this.listQuery);
